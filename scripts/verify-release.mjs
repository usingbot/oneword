...
import { licenseAssets, existingPdfNotices } from './license-assets.mjs'
...
for (const name of ['react', 'react-dom', 'scheduler', 'dexie', 'pdfjs-dist', 'ts-fsrs']) {
...
process.stdout.write(`Release metadata and ${licenseAssets.length + existingPdfNotices.length} exact license/notice assets verified.\n`)
